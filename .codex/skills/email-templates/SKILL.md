...
1. Read `docs/02-system-requirements.md` for notification-related requirements.
2. Read `docs/03-system-design.md` for notification module and external service config.
3. Read `docs/01b-product-spec.md` (if exists) for user stories that trigger emails.
4. Read `docs/03b-ux-design.md` (if exists) for brand colors, fonts, and logo reference.
