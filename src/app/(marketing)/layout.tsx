...
export const metadata: Metadata = {
  ...
  description:
    "Get 5–15 curated re-roof DA leads across 15 Greater Sydney LGAs every Sunday at 6 pm. AUD 99/mo (GST included). 28-day trial. No annual lock-in.",

  // Open Graph
  openGraph: {
    title: "ProjectIntelligence AU — Sydney Roofing DA Digest",
    description:
      "Weekly email + SMS digest of 5–15 re-roof DAs across 15 Sydney LGAs. AUD 99/mo, GST included. 28-day trial. No sales call. Signup in 60 seconds.",
