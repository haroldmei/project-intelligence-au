...
1. Read `docs/01b-product-spec.md` for success metrics (KPIs) that need to be measured.
2. Read `docs/01-market-analysis.md` for business model and revenue metrics.
3. Read `docs/02-system-requirements.md` for user flows that should be tracked.
4. Read `docs/03b-ux-design.md` (if exists) for page structure and user flows.
