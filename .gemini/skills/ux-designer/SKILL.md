...
1. Read `docs/01-market-analysis.md` for brand positioning and target audience.
2. Read `docs/01b-product-spec.md` (if exists) for user personas and story map.
3. Read `docs/02-system-requirements.md` for functional requirements.
4. Read `docs/03-system-design.md` for technology stack (Tailwind, React, etc.).
...
Define the brand identity and the complete design system:

### 3a. Brand Identity & Mood Board
- Define the brand "personality" (e.g., Bold, Friendly, Minimalist, Corporate).
- Describe a "Mood Board" with keywords, textures, and visual metaphors.
- Define Logo usage guidelines and core visual style (e.g., gradients, shadows, border styles).
...
2. Brand Identity & Mood Board (personality, visual style, keywords)
3. Color Palette (with swatches shown as colored blocks in markdown)
4. Typography Scale
5. Spacing & Layout System
6. Component Inventory (with variants)
7. Wireframes (ASCII art for each page)
8. User Flow Diagrams (Mermaid)
